<template>
  <div>
    ...
    <el-table :data="table" v-if="table.length > 0">
      ...
      <el-table-column prop="phone" label="电话" v-if="showPhone"></el-table-column>
    ...
    <el-dialog :close-on-click-modal="false" title="员工信息" :visible.sync="dialogFormVisible"  :before-close="handleClose">
     ...
     <el-dialog :close-on-click-modal="false" title="更多信息" :visible.sync="dialogFormVisible2"  :before-close="handleClose2" class="dia">
      <el-form :model="form2">
        <el-form-item label="工作日偏好" :label-width="formLabelWidth">
          <el-input v-model="form2.workday" autocomplete="off" class="inpt1"></el-input>
        </el-form-item>
  
        <el-form-item label="工作时间偏好" :label-width="formLabelWidth">
          <el-input v-model="form2.workhour" autocomplete="off" class="inpt1"></el-input>
        </el-form-item>
        <el-form-item label="班次时长偏好/h" :label-width="formLabelWidth">
          <el-input v-model="form2.worklast" autocomplete="off" class="inpt1"></el-input>
        </el-form-item>
     
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click="handleClose2">取 消</el-button>
        <el-button type="primary" @click="confirmEdit2"
          >确 定</el-button
        >
      </div>
    </el-dialog>
...
<script>
import {employeeinfo,  reqChangeinfo, allemployee,reqRmove } from "../../api/employee";
  ...
  methods: {
    ...
    searchMore(data)
    {
      ...
      console.log("这是form",this.form);
       ...
       if(data.employeeLastTimeDTO===null||data.employeeWorkTimeDTO===null||data.employeeLastTimeDTO===null)
       {
         console.log("*****************************")
