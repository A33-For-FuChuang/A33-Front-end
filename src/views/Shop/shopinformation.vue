<template>
  <div>
    ...
    <br>
    <el-button type="primary" @click="dialogFormVisible = true">添加商铺</el-button>
    <el-dialog title="添加商铺" :visible.sync="dialogFormVisible">
      <el-form :model="newShop" :rules="rules" ref="newShopForm" label-width="100px">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        size: [{ required: true, message: '商铺面积不能为空', trigger: 'blur' }]
      }
    };
  },
   created() {
